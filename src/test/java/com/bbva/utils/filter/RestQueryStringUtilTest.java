...
public class RestQueryStringUtilTest {
	...
	private static final java.lang.String QUERY_STRING_3 = "director.lastName==Nolan;year=ge=2000;year=lt=2010;distributionDate==20015;budget==948374.27";
	...
	public void testToDtoExtOnHttpServletRequest() throws Exception {
		...
		// TODO AMM: Falte culminar esta prueba. Los campos indexados mas allá
		// del nivel 2 no se ven bien
